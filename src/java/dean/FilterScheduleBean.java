 ...
 * @author root
 */
public class FilterScheduleBean {
     String schId,counsNo,dtaway,taway,dtback,tback,reason,approve;

    public FilterScheduleBean(String schId, String counsNo, String dtaway,String taway, String dtback, String tback, String reason, String approve) {
        this.schId = schId;
