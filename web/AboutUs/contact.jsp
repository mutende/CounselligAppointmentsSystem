<%-- 
    Document   : contact
    Created on : Jan 14, 2019, 12:58:46 PM
    Author     : Alex
--%>
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark probootstrap-navabr-dark">
        <div class="container">
          <a class="navbar-brand" href="contact.jsp">Contact Us</a>
          ...
          <div class="collapse navbar-collapse" id="probootstrap-nav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="contact.jsp" class="nav-link active">Contact</a></li>
               <li class="nav-item"><a href="../dean/index.jsp" class="nav-link">Back</a></li>
          ...
          <div class="col-sm">
            <div class="probootstrap-text pt-5">
              ...
              <div class="probootstrap-subheading mb-5">
                <p class="h4 font-weight-normal">Free Counselling For Students</u></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="probootstrap-section">
      <div class="container">
        ...
        <p>
          ...
          <br/>
          Book An Appointment To See A Counsellor From Monday To Friday From 8:00 Am To 5:30 PM.
          <br/>
          An Appointment Must Be Booked A Day Before.
          <br/>
          Contact Us Through These Hot-line Incase Of An Emergency.
